...
type KeyCloakExec interface {
	...
	Login(ctx context.Context) (*gocloak.JWT, error)
	...
	VerifyToken(ctx context.Context, token string) (*gocloak.IntroSpectTokenResult, error)
